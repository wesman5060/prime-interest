...
export async function POST(req: NextRequest) {
  ...
  const [inbound, confirmation] = await Promise.all([
    ...
    resend.emails.send({
      from: "Prime Interest, Inc. <onboarding@resend.dev>",
      to: email,
      subject: "We received your message — Prime Interest, Inc.",
      text: [
        `Hi ${name},`,
        ``,
        `Thank you for reaching out to Prime Interest, Inc. We've received your message and Marty will be in touch shortly.`,
        ``,
